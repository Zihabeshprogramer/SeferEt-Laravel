                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <small class="text-muted d-block mt-2">
                                            <i class="fas fa-info-circle"></i> Accepted: JPG, JPEG, PNG (Max 5MB each, up to 10 images)
                                        </small>
                                        @error('images')
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                ...
                                <button type="submit" class="btn btn-primary btn-lg" id="submitBtn">
                                    <i class="fas fa-save me-1"></i> Create Hotel
                                </button>
                            </div>
                        </div>
                    </div>
...
$(document).ready(function() {
    console.log('Hotel create page loaded');
    ...
    if (typeof Inputmask !== 'undefined') {
        ...
        // Distance masks - decimal with 1 decimal place, max 9999.9 km
        Inputmask({
            alias: 'decimal',
            groupSeparator: '',
            digits: 2,
    ...
    if (hotelForm) {
        hotelForm.addEventListener('submit', function(e) {
            ...
            if (submitBtn) {
                ...
                submitBtn.innerHTML = '<i class="fas fa-spinner fa-spin me-1"></i> Creating Hotel...';
            }
        });
    }
});
